...
from sklearn.linear_model import LogisticRegression # first best model trained 
...
sub.to_csv('submission_test_17_final.csv', index=False)
...
y_val_predicted_logisticr = logisticr_model.predict(X_val_BoW)
